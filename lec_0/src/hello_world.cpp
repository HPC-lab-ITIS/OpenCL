...
"__kernel void hello(__constant double *input, __global double *output)\n"\
"{\n"\
...
int main(void)
{
    ...
    size_t global = n;// global domain size
    ...
    // Create the input (a) and output (b) arrays in device memory
    d_a  = clCreateBuffer(
                            context,  
                            CL_MEM_READ_ONLY,  
                            sizeof(double) * n, 
