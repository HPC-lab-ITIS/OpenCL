...
int main(int argc, char** argv)
{
    ...
    std::ifstream ifs("reduce_2stage.cl");
    ...
    reduce = clCreateKernel(program, "reduce_stage", &err);
    ...
    prof.tic("2-stage reduction opencl");
    ...
    prof.toc("2-stage reduction opencl");
