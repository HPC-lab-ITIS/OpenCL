...
int main(int argc, char** argv)
{
    ...
    std::ifstream ifs("reduce_simd.cl");
    ...
    reduce = clCreateKernel(program, "reduce_simd", &err);
    ...
    err |= clSetKernelArg(reduce, 3, sizeof(int), &n_tmp);
    checkError(err, "Setting kernel arguments");
    
    prof.tic("simd reduction opencl");
    ...
    prof.toc("simd reduction opencl");
